...
csv_output = Path("/home/aboubakr/Descargas/article4/ham10000/pipeline4/efficientnetb6_results.csv")
...
print("✅ EfficientNetB6 compiled successfully")
...
plt.title("Confusion Matrix  EfficientNetB6", fontweight='bold')
plt.tight_layout()
plt.show()
...
plt.title("ROC Curves  EfficientNetB6 (HAM10000)", fontweight='bold')
plt.legend()
plt.grid(alpha=0.3)
plt.tight_layout()
plt.show()
