...
csv_output = Path("/home/aboubakr/Descargas/article4/ham10000/pipeline4/efficientnetb5_results.csv")

IMG_SIZE = (456, 456)   # EfficientNetB5 input size
BATCH_SIZE = 16
EPOCHS = 5
NUM_CLASSES = 7
...
print("✅ EfficientNetB5 compiled successfully")
...
plt.title("Confusion Matrix  EfficientNetB5", fontweight='bold')
plt.tight_layout()
plt.show()
...
plt.title("ROC Curves  EfficientNetB5 (HAM10000)", fontweight='bold')
plt.legend()
plt.grid(alpha=0.3)
plt.tight_layout()
plt.show()
