...
if len(df) == 0:
    raise RuntimeError("❌ No images found. Check overlay folder or file extension.")
...
print("✅ EfficientNetB2 compiled successfully")
...
plt.title("Confusion Matrix – EfficientNetB2", fontweight='bold')
plt.tight_layout()
plt.show()
...
plt.title("ROC Curves – EfficientNetB2 (HAM10000)", fontweight='bold')
plt.legend()
plt.grid(alpha=0.3)
plt.tight_layout()
plt.show()
