"""
HAM10000 ResNet50 Segmented Images Classification Pipeline
...
- Uses official ImageNet pretrained ResNet50
"""
...
OUTPUT_CSV = "/aakaou/ham10000_resnet50_segmented_predictions_p3.csv"
...
print("✅ ResNet50 ready (50 layers, ImageNet pretrained!)")
...
if results:
    ...
    print(f"\n✅ ResNet50 SEGMENTED predictions saved: {OUTPUT_CSV}")
...
plt.title('ROC Curves - ResNet50 7-class', fontsize=16, fontweight='bold')
