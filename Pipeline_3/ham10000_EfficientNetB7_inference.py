"""
EfficientNetB7 HAM10000 7-Class Skin Lesion Classification
...
OUTPUT_CSV = "/aakaou/ham10000_efficientnetb7_7class_predictions_p3.csv"
ROC_FIG = "/aakaou/efficientnetb7_p3_roc_curve.png"
...
def build_model():
    ...
    print("✅ EfficientNetB7 model loaded")
    return model
...
def run_predictions(model):
    ...
    results=[]
    for i in tqdm(range(0,len(files),BATCH_SIZE), desc="EfficientNetB7 Predicting"):
