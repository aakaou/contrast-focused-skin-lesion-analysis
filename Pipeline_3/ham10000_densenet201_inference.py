...
"""
HAM10000 DenseNet201 7-Class Segmented Images Classification Pipeline
...
- Uses official ImageNet pretrained DenseNet201
"""
...
OUTPUT_CSV = "/aakaou/ham10000_densenet201_7class_predictions_p3.csv"
...
# 4️⃣ MODEL SETUP
# ======================
print("🔄 Loading DenseNet201 (ImageNet pretrained)...")
...
print("✅ DenseNet201 7-class model loaded (201 layers!)")
...
# ======================
results = []
print("🚀 DenseNet201 predictions...")
for i in tqdm(range(0, len(proc_files), BATCH_SIZE), desc="DenseNet201 Predicting"):
...
plt.title('ROC Curves - DenseNet201 7-class', fontsize=16, fontweight='bold')
