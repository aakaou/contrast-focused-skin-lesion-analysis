"""
HAM10000 DenseNet121 Segmented Images Classification Pipeline
...
- Uses official ImageNet pretrained DenseNet121
"""
...
OUTPUT_CSV = "/aakaou/ham10000_densenet121_segmented_predictions_p3.csv"
...
if results:
    ...
    print(f"\n✅ DenseNet121 SEGMENTED predictions saved: {OUTPUT_CSV}")
