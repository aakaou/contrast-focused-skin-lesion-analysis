...
- Uses official ImageNet pretrained InceptionV3
"""
...
OUTPUT_CSV = "/aakaou/ham10000_inceptionv3_7class_predictions_p3.csv"
...
# 4️⃣ MODEL SETUP
# ======================
print("🔄 Loading InceptionV3 (ImageNet pretrained)...")
