"""
EfficientNetB5 HAM10000 7-Class Skin Lesion Classification
...
OUTPUT_CSV = "/aakaou/ham10000_efficientnetb5_7class_predictions_p3.csv"
ROC_FIG = "/aakaou/efficientnetb5_p3_roc_curve.png"
...
def plot_roc(df):
    ...
    plt.title("ROC Curves EfficientNetB5")

    plt.legend()

    plt.tight_layout()

    print("ROC saved:",ROC_FIG)
