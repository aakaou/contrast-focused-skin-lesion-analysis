"""
EfficientNetB6 HAM10000 7-Class Skin Lesion Classification
...
OUTPUT_CSV = "/aakaou/ham10000_efficientnetb6_7class_predictions_p3.csv"
ROC_FIG = "/aakaou/efficientnetb6_p3_roc_curve.png"
...
def build_model():
    ...
    print("✅ EfficientNetB6 model loaded")
    return model
...
def run_predictions(model):
    ...
    results=[]
    for i in tqdm(range(0,len(files),BATCH_SIZE), desc="EfficientNetB6 Predicting"):
...
def plot_roc(df):
    ...
    plt.title("ROC Curves - EfficientNetB6")
