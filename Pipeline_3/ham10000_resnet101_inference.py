...
"""
HAM10000 ResNet101 Segmented Images Classification Pipeline
...
- Uses official ImageNet pretrained ResNet101
"""
...
OUTPUT_CSV = "/aakaou/ham10000_resnet101_segmented_predictions_p3.csv"
...
# 4️⃣ MODEL SETUP
# ======================
print("🔄 Loading ResNet101 (ImageNet pretrained)...")
...
print("✅ ResNet101 ready (101 layers, ImageNet pretrained!)")
...
if results:
    ...
    print(f"\n✅ ResNet101 SEGMENTED predictions saved: {OUTPUT_CSV}")
...
plt.title('ROC Curves - ResNet101 7-class', fontsize=16, fontweight='bold')
