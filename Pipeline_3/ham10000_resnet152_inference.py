...
"""
HAM10000 ResNet152V2 Segmented Images Classification Pipeline
...
- Uses official ImageNet pretrained ResNet152V2
"""
...
# 2️⃣ SETTINGS
# ======================
PROC_DIR = Path("/aakaou/red_sonar_segmented_images")  # Segmented images folder
OUTPUT_CSV = "/aakaou/ham10000_resnet152_segmented_predictions_p3.csv"
...
if results:
    ...
    print(f"\n✅ ResNet152 SEGMENTED predictions saved: {OUTPUT_CSV}")
...
plt.title('ROC Curves - ResNet152V2 7-class', fontsize=16, fontweight='bold')
