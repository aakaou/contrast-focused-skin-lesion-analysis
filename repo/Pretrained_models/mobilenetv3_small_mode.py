# ======================================================
# mobilenetv3_small_all_pipelines.py
# ======================================================
...
IMG_SIZE = (224, 224)  # MobileNetV3Small default input size
BATCH_SIZE = 32        # Very lightweight - large batch
...
pipelines_info = [

    {
        ...
        "csv": r"/aakaou/pipeline1_mobilenetv3small_predictions.csv"
    },

    {
        "images": r"/aakaou/pipeline2_seg_overlays",
        "csv": r"/aakaou/pipeline2_mobilenetv3small_predictions.csv"
    },

    {
        "images": r"/aakaou/pipeline3_seg_overlays",
        "csv": r"/aakaou/pipeline3_mobilenetv3small_predictions.csv"
    },

    {
        "images": r"/aakaou/pipeline4_overlays",
        "csv": r"/aakaou/pipeline4_mobilenetv3small_predictions.csv"
    }
...
for pipe in pipelines_info:
    ...
    print(f"\n🚀 Training MobileNetV3-Small on {pipe['images']}")
    ...
    print("✅ MobileNetV3-Small model ready")
