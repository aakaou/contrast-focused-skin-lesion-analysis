...
pipelines_info = [

    {
        ...
        "csv": r"/aakaou/pipeline1_resnet152_predictions.csv"
    },

    {
        "images": r"/aakaou/pipeline2_seg_overlays",
        "csv": r"/aakaou/pipeline2_resnet152_predictions.csv"
    },

    {
        "images": r"/aakaou/pipeline3_seg_overlays",
        "csv": r"/aakaou/pipeline3_resnet152_predictions.csv"
    },

    {
        "images": r"/aakaou/pipeline4_overlays",
        "csv": r"/aakaou/pipeline4_resnet152_predictions.csv"
    }
...
for pipe in pipelines_info:
    ...
    print(f"\n🚀 Training ResNet152 on {pipe['images']}")
