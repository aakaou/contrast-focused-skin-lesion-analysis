# ==========================================================
# FULL RESNET18 CLINICAL PIPELINE
...
DATASET_CONFIGS = [
    {
        ...
        "file_ext": ".jpg",
        "output_dir": "/path/to/resnet18_results"
    },
    {
        ...
        "file_ext": ".jpg",
        "output_dir": "/path/to/ham10000/resnet18_results"
    }
]
...
def run_pipeline(cfg):
    ...
    pred_df.to_csv(output_dir / "resnet18_predictions.csv", index=False)
    print("Saved: resnet18_predictions.csv")
    ...
    report_df.to_csv(output_dir / "classification_report_resnet18.csv")
    ...
    save_confusion_matrix(
        cm,
        output_dir / "confusion_matrix_resnet18.png",
        f"{cfg['name']} ResNet18 Confusion Matrix"
    )
    ...
    auc_m, auc_b = save_roc_curve(
        y_true,
        y_probs,
        output_dir / "roc_auc_resnet18.png",
        f"{cfg['name']} ResNet18 ROC Curve"
    )
    ...
    save_pr_curve(
        ...
        precision,
        pr_auc,
        output_dir / "precision_recall_resnet18.png",
        f"{cfg['name']} ResNet18 Precision-Recall Curve"
    )
    ...
    summary_df.to_csv(output_dir / "final_metrics_summary_resnet18.csv", index=False)
    save_json(summary, output_dir / "final_metrics_summary_resnet18.json")
...
if __name__ == "__main__":
    ...
    if len(all_results) > 0:
        ...
        combined_out = Path("./combined_resnet18_results")
        ensure_dir(combined_out)

        combined_df.to_csv(
            combined_out / "all_datasets_summary_resnet18.csv",
            index=False
        )
        save_json(
            all_results,
            combined_out / "all_datasets_summary_resnet18.json"
        )
