# ======================================================
# efficientnetb3_all_pipelines.py
# ======================================================
...
BATCH_SIZE = 8         # Smaller batch for larger resolution/model
...
pipelines_info = [

    {
        ...
        "csv": r"/aakaou/pipeline1_efficientnetb3_predictions.csv"
    },

    {
        "images": r"/aakaou/pipeline2_seg_overlays",
        "csv": r"/aakaou/pipeline2_efficientnetb3_predictions.csv"
    },

    {
        "images": r"/aakaou/pipeline3_seg_overlays",
        "csv": r"/aakaou/pipeline3_efficientnetb3_predictions.csv"
    },

    {
        "images": r"/aakaou/pipeline4_overlays",
        "csv": r"/aakaou/pipeline4_efficientnetb3_predictions.csv"
    }
...
for pipe in pipelines_info:
    ...
    print(f"\n🚀 Training EfficientNetB3 on {pipe['images']}")
    ...
    print("✅ EfficientNetB3 model ready")
