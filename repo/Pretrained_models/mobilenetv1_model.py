...
IMG_SIZE = (224, 224)  # MobileNetV1 default input size
BATCH_SIZE = 32        # Larger batch - MobileNet is lightweight
...
pipelines_info = [

    {
        ...
        "csv": r"/aakaou/pipeline1_mobilenetv1_predictions.csv"
    },

    {
        "images": r"/aakaou/pipeline2_seg_overlays",
        "csv": r"/aakaou/pipeline2_mobilenetv1_predictions.csv"
    },

    {
        "images": r"/aakaou/pipeline3_seg_overlays",
        "csv": r"/aakaou/pipeline3_mobilenetv1_predictions.csv"
    },

    {
        "images": r"/aakaou/pipeline4_overlays",
        "csv": r"/aakaou/pipeline4_mobilenetv1_predictions.csv"
    }
...
for pipe in pipelines_info:
    ...
    print(f"\n🚀 Training MobileNetV1 on {pipe['images']}")
    ...
    base_model = MobileNet(
        ...
        alpha=1.0,           # Full precision (not quantized)
        include_top=False,
        weights="imagenet"
    )
