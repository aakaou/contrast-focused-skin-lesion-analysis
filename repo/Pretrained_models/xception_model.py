...
BATCH_SIZE = 16        # Balanced for Xception memory usage
...
pipelines_info = [

    {
        ...
        "csv": r"/aakaou/pipeline1_xception_predictions.csv"
    },

    {
        "images": r"/aakaou/pipeline2_seg_overlays",
        "csv": r"/aakaou/pipeline2_xception_predictions.csv"
    },

    {
        "images": r"/aakaou/pipeline3_seg_overlays",
        "csv": r"/aakaou/pipeline3_xception_predictions.csv"
    },

    {
        "images": r"/aakaou/pipeline4_overlays",
        "csv": r"/aakaou/pipeline4_xception_predictions.csv"
    }
...
for pipe in pipelines_info:
    ...
    print(f"\n🚀 Training Xception on {pipe['images']}")
