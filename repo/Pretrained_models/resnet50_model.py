...
from tensorflow.keras.applications import ResNet50  # <— main change [code_file:0]
...
pipelines_info = [

    {
        ...
        "csv": r"/aakaou/pipeline1_resnet50_predictions.csv"
    },

    {
        "images": r"/aakaou/pipeline2_seg_overlays",
        "csv": r"/aakaou/pipeline2_resnet50_predictions.csv"
    },

    {
        "images": r"/aakaou/pipeline3_seg_overlays",
        "csv": r"/aakaou/pipeline3_resnet50_predictions.csv"
    },

    {
        "images": r"/aakaou/pipeline4_overlays",
        "csv": r"/aakaou/pipeline4_resnet50_predictions.csv"
    }
...
for pipe in pipelines_info:
    ...
    print(f"\n🚀 Training ResNet50 on {pipe['images']}")
