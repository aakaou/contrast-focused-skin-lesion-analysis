...
BATCH_SIZE = 32        # Larger batch - MobileNetV2 is very lightweight
...
pipelines_info = [

    {
        ...
        "csv": r"/aakaou/pipeline1_mobilenetv2_predictions.csv"
    },

    {
        "images": r"/aakaou/pipeline2_seg_overlays",
        "csv": r"/aakaou/pipeline2_mobilenetv2_predictions.csv"
    },

    {
        "images": r"/aakaou/pipeline3_seg_overlays",
        "csv": r"/aakaou/pipeline3_mobilenetv2_predictions.csv"
    },

    {
        "images": r"/aakaou/pipeline4_overlays",
        "csv": r"/aakaou/pipeline4_mobilenetv2_predictions.csv"
    }
...
for pipe in pipelines_info:
    ...
    print(f"\n🚀 Training MobileNetV2 on {pipe['images']}")
