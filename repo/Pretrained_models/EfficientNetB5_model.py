# ==========================================================
# FULL EFFICIENTNET-B5 CLINICAL PIPELINE
...
DATASET_CONFIGS = [
    {
        ...
        "patient_col": "patient_id",
        "file_ext": ".jpg",
        "output_dir": "/path/to/efficientb5_results"
    },
    {
        ...
        "patient_col": "lesion_id",
        "file_ext": ".jpg",
        "output_dir": "/path/to/ham10000/efficientb5_results"
    }
]
...
def run_pipeline(cfg):
    ...
    best_model_path = output_dir / "best_efficientnet_b5.pth"
    torch.save(best_state, best_model_path)

    history_df = pd.DataFrame(history)
    history_df.to_csv(output_dir / "training_history_efficientb5.csv", index=False)
    ...
    print("Best EfficientNet-B5 loaded ✔")
    ...
    pred_df.to_csv(output_dir / "efficientnetb5_predictions.csv", index=False)
    ...
    report_df.to_csv(output_dir / "classification_report_efficientb5.csv")
    ...
    save_confusion_matrix(
        cm,
        output_dir / "confusion_matrix_efficientb5.png",
    ...
    auc_m, auc_b = save_roc_curve(
        y_true,
        y_probs,
        output_dir / "roc_auc_efficientb5.png",
    ...
    save_pr_curve(
        ...
        precision,
        pr_auc,
        output_dir / "precision_recall_efficientb5.png",
    ...
    summary_df.to_csv(output_dir / "final_metrics_summary_efficientb5.csv", index=False)
    save_json(summary, output_dir / "final_metrics_summary_efficientb5.json")

    print("\n==============================")
    print(f"{cfg['name']} EfficientNet-B5 Results")
    print("==============================")
...
if __name__ == "__main__":
    ...
    if len(all_results) > 0:
        ...
        combined_out = Path("./combined_efficientb5_results")
        ensure_dir(combined_out)

        combined_df.to_csv(
            combined_out / "all_datasets_summary_efficientb5.csv",
            index=False
        )
        save_json(
            all_results,
            combined_out / "all_datasets_summary_efficientb5.json"
        )
