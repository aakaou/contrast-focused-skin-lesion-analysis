# ======================================================
# efficientnetb5_all_pipelines.py
# ======================================================
...
BATCH_SIZE = 2         # Very small batch for 456x456 + massive model
...
pipelines_info = [

    {
        ...
        "csv": r"/aakaou/pipeline1_efficientnetb5_predictions.csv"
    },

    {
        "images": r"/aakaou/pipeline2_seg_overlays",
        "csv": r"/aakaou/pipeline2_efficientnetb5_predictions.csv"
    },

    {
        "images": r"/aakaou/pipeline3_seg_overlays",
        "csv": r"/aakaou/pipeline3_efficientnetb5_predictions.csv"
    },

    {
        "images": r"/aakaou/pipeline4_overlays",
        "csv": r"/aakaou/pipeline4_efficientnetb5_predictions.csv"
    }
...
for pipe in pipelines_info:
    ...
    print(f"\n🚀 Training EfficientNetB5 on {pipe['images']}")
    ...
    print("✅ EfficientNetB5 model ready")
