...
pipelines_info = [

    {
        ...
        "csv": r"/aakaou/pipeline1_densenet169_predictions.csv"
    },

    {
        "images": r"/aakaou/pipeline2_seg_overlays",
        "csv": r"/aakaou/pipeline2_densenet169_predictions.csv"
    },

    {
        "images": r"/aakaou/pipeline3_seg_overlays",
        "csv": r"/aakaou/pipeline3_densenet169_predictions.csv"
    },

    {
        "images": r"/aakaou/pipeline4_overlays",
        "csv": r"/aakaou/pipeline4_densenet169_predictions.csv"
    }
...
for pipe in pipelines_info:
    ...
    print(f"\n🚀 Training DenseNet169 on {pipe['images']}")
