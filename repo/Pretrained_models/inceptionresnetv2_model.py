# ======================================================
# inceptionresnetv2_all_pipelines.py
# ======================================================
...
IMG_SIZE = (299, 299)  # InceptionResNetV2 default input size
BATCH_SIZE = 8         # Smaller batch for large model + 299x299
...
pipelines_info = [

    {
        ...
        "csv": r"/aakaou/pipeline1_inceptionresnetv2_predictions.csv"
    },

    {
        "images": r"/aakaou/pipeline2_seg_overlays",
        "csv": r"/aakaou/pipeline2_inceptionresnetv2_predictions.csv"
    },

    {
        "images": r"/aakaou/pipeline3_seg_overlays",
        "csv": r"/aakaou/pipeline3_inceptionresnetv2_predictions.csv"
    },

    {
        "images": r"/aakaou/pipeline4_overlays",
        "csv": r"/aakaou/pipeline4_inceptionresnetv2_predictions.csv"
    }
...
for pipe in pipelines_info:
    ...
    print(f"\n🚀 Training InceptionResNetV2 on {pipe['images']}")
    ...
    print("✅ InceptionResNetV2 model ready")
