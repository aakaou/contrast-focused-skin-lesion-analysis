# ======================================================
# efficientnetb7_all_pipelines.py
# ======================================================
...
IMG_SIZE = (600, 600)  # EfficientNetB7 default input size
BATCH_SIZE = 1         # Single image batch - EXTREME memory requirements
...
pipelines_info = [

    {
        ...
        "csv": r"/aakaou/pipeline1_efficientnetb7_predictions.csv"
    },

    {
        "images": r"/aakaou/pipeline2_seg_overlays",
        "csv": r"/aakaou/pipeline2_efficientnetb7_predictions.csv"
    },

    {
        "images": r"/aakaou/pipeline3_seg_overlays",
        "csv": r"/aakaou/pipeline3_efficientnetb7_predictions.csv"
    },

    {
        "images": r"/aakaou/pipeline4_overlays",
        "csv": r"/aakaou/pipeline4_efficientnetb7_predictions.csv"
    }
...
for pipe in pipelines_info:
    ...
    print(f"\n🚀 Training EfficientNetB7 on {pipe['images']}")
    ...
    print("✅ EfficientNetB7 model ready")
