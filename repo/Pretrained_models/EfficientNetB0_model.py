# ======================================================
# efficientnetb0_all_pipelines.py
# ======================================================
...
BATCH_SIZE = 16        # Balanced for EfficientNetB0
...
pipelines_info = [

    {
        ...
        "csv": r"/aakaou/pipeline1_efficientnetb0_predictions.csv"
    },

    {
        "images": r"/aakaou/pipeline2_seg_overlays",
        "csv": r"/aakaou/pipeline2_efficientnetb0_predictions.csv"
    },

    {
        "images": r"/aakaou/pipeline3_seg_overlays",
        "csv": r"/aakaou/pipeline3_efficientnetb0_predictions.csv"
    },

    {
        "images": r"/aakaou/pipeline4_overlays",
        "csv": r"/aakaou/pipeline4_efficientnetb0_predictions.csv"
    }
...
for pipe in pipelines_info:
    ...
    print(f"\n🚀 Training EfficientNetB0 on {pipe['images']}")
