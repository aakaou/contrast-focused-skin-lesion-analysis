# ==========================================================
# FULL EFFICIENTNET-B0 CLINICAL PIPELINE
...
# ==========================================================
# IMPORTANT:
# - Update paths and column names if needed.
# - For HAM10000, you may use:
#     img_col = "image_id"
#     patient_col = "lesion_id"   # often better than image_id
# - For ISIC 2024, common columns include:
#     img_col = "isic_id"
#     label_col = "target"
...
DATASET_CONFIGS = [
    {
        ...
        "patient_col": "patient_id",
        "file_ext": ".jpg",
        "output_dir": "/path/to/efficientb0_results"
    },
    {
        ...
        "file_ext": ".jpg",
        "output_dir": "/path/to/ham10000/efficientb0_results"
    }
]

# ==========================================================
# TRANSFORMS
# EfficientNet-B0 pretrained weights use ImageNet normalization.
# Torchvision documents mean=[0.485,0.456,0.406] and
# std=[0.229,0.224,0.225] for these pretrained weights.
# ==========================================================
...
# ==========================================================
# MODEL
# Torchvision EfficientNet-B0 supports pretrained weights
# via EfficientNet_B0_Weights.IMAGENET1K_V1 / DEFAULT.
# ==========================================================
...
def run_pipeline(cfg):
    ...
    print("Best EfficientNet-B0 loaded ✔")
    ...
    pred_df.to_csv(output_dir / "efficientnetb0_predictions.csv", index=False)
    ...
    report_df.to_csv(output_dir / "classification_report_efficientb0.csv")
    ...
    save_confusion_matrix(
        cm,
        output_dir / "confusion_matrix_efficientb0.png",
    ...
    auc_m, auc_b = save_roc_curve(
        y_true,
        y_probs,
        output_dir / "roc_auc_efficientb0.png",
    ...
    save_pr_curve(
        ...
        precision,
        pr_auc,
        output_dir / "precision_recall_efficientb0.png",
    ...
    save_json(summary, output_dir / "final_metrics_summary.json")
...
if __name__ == "__main__":
    ...
    if len(all_results) > 0:
        ...
        combined_out = Path("./combined_efficientb0_results")
        ensure_dir(combined_out)

        combined_df.to_csv(combined_out / "all_datasets_summary.csv", index=False)
        save_json(
            all_results,
            combined_out / "all_datasets_summary.json"
        )
