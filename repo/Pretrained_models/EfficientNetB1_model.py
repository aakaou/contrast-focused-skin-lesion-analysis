# ==========================================================
# FULL EFFICIENTNET-B1 CLINICAL PIPELINE
...
# - For HAM10000, common columns include:
#     img_col = "image_id"
#     patient_col = "lesion_id"
#     label_col = "dx"
# - For ISIC 2024 style metadata, your current setup uses:
#     img_col = "isic_id"
#     label_col = "target"
...
DATASET_CONFIGS = [
    {
        ...
        "patient_col": "patient_id",
        "file_ext": ".jpg",
        "output_dir": "/path/to/efficientb1_results"
    },
    {
        ...
        "patient_col": "lesion_id",
        "file_ext": ".jpg",
        "output_dir": "/path/to/ham10000/efficientb1_results"
    }
]

# ==========================================================
# TRANSFORMS
# EfficientNet-B1 pretrained weights use ImageNet normalization.
# ==========================================================
...
# ==========================================================
# MODEL
# Torchvision EfficientNet-B1 supports pretrained weights
# via EfficientNet_B1_Weights.IMAGENET1K_V1 / DEFAULT.
# ==========================================================
...
def run_pipeline(cfg):
    ...
    # Save best model
    best_model_path = output_dir / "best_efficientnet_b1.pth"
    ...
    print("Best EfficientNet-B1 loaded ✔")
    ...
    pred_df.to_csv(output_dir / "efficientnetb1_predictions.csv", index=False)
    ...
    report_df.to_csv(output_dir / "classification_report_efficientb1.csv")
    ...
    save_confusion_matrix(
        cm,
        output_dir / "confusion_matrix_efficientb1.png",
    ...
    auc_m, auc_b = save_roc_curve(
        y_true,
        y_probs,
        output_dir / "roc_auc_efficientb1.png",
    ...
    save_pr_curve(
        ...
        precision,
        pr_auc,
        output_dir / "precision_recall_efficientb1.png",
...
if __name__ == "__main__":
    ...
    if len(all_results) > 0:
        ...
        combined_out = Path("./combined_efficientb1_results")
