# ======================================================
# efficientnetb6_all_pipelines.py
# ======================================================
...
IMG_SIZE = (528, 528)  # EfficientNetB6 default input size
BATCH_SIZE = 1         # Single image batch for 528x528 + 43M parameters
...
pipelines_info = [

    {
        ...
        "csv": r"/aakaou/pipeline1_efficientnetb6_predictions.csv"
    },

    {
        "images": r"/aakaou/pipeline2_seg_overlays",
        "csv": r"/aakaou/pipeline2_efficientnetb6_predictions.csv"
    },

    {
        "images": r"/aakaou/pipeline3_seg_overlays",
        "csv": r"/aakaou/pipeline3_efficientnetb6_predictions.csv"
    },

    {
        "images": r"/aakaou/pipeline4_overlays",
        "csv": r"/aakaou/pipeline4_efficientnetb6_predictions.csv"
    }
...
for pipe in pipelines_info:
    ...
    print(f"\n🚀 Training EfficientNetB6 on {pipe['images']}")
    ...
    print("✅ EfficientNetB6 model ready")
