# ======================================================
# efficientnetb4_all_pipelines.py
# ======================================================
...
BATCH_SIZE = 4         # Very small batch for 380x380 + large model
...
pipelines_info = [

    {
        ...
        "csv": r"/aakaou/pipeline1_efficientnetb4_predictions.csv"
    },

    {
        "images": r"/aakaou/pipeline2_seg_overlays",
        "csv": r"/aakaou/pipeline2_efficientnetb4_predictions.csv"
    },

    {
        "images": r"/aakaou/pipeline3_seg_overlays",
        "csv": r"/aakaou/pipeline3_efficientnetb4_predictions.csv"
    },

    {
        "images": r"/aakaou/pipeline4_overlays",
        "csv": r"/aakaou/pipeline4_efficientnetb4_predictions.csv"
    }
...
for pipe in pipelines_info:
    ...
    print(f"\n🚀 Training EfficientNetB4 on {pipe['images']}")
