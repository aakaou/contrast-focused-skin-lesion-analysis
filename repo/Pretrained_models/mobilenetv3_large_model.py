# ==========================================================
# FULL MOBILENETV3_LARGE CLINICAL PIPELINE
...
DATASET_CONFIGS = [
    {
        ...
        "file_ext": ".jpg",
        "output_dir": "/path/to/mobilenetv3_large_results"
    },
    {
        ...
        "file_ext": ".jpg",
        "output_dir": "/path/to/ham10000/mobilenetv3_large_results"
    }
]
...
def run_pipeline(cfg):
    ...
    best_model_path = output_dir / "best_mobilenetv3_large.pth"
    torch.save(best_state, best_model_path)

    history_df = pd.DataFrame(history)
    history_df.to_csv(output_dir / "training_history_mobilenetv3_large.csv", index=False)
    ...
    print("Best MobileNetV3 Large loaded ✔")
    ...
    pred_df.to_csv(output_dir / "mobilenetv3_large_predictions.csv", index=False)
    ...
    report_df.to_csv(output_dir / "classification_report_mobilenetv3_large.csv")
    ...
    save_confusion_matrix(
        cm,
        output_dir / "confusion_matrix_mobilenetv3_large.png",
    ...
    auc_m, auc_b = save_roc_curve(
        y_true,
        y_probs,
        output_dir / "roc_auc_mobilenetv3_large.png",
    ...
    save_pr_curve(
        ...
        precision,
        pr_auc,
        output_dir / "precision_recall_mobilenetv3_large.png",
    ...
    summary_df.to_csv(output_dir / "final_metrics_summary_mobilenetv3_large.csv", index=False)
    save_json(summary, output_dir / "final_metrics_summary_mobilenetv3_large.json")

    print("\n==============================")
    print(f"{cfg['name']} MobileNetV3 Large Results")
    print("==============================")
...
if __name__ == "__main__":
    ...
    if len(all_results) > 0:
        ...
        combined_out = Path("./combined_mobilenetv3_large_results")
        ensure_dir(combined_out)

        combined_df.to_csv(
            combined_out / "all_datasets_summary_mobilenetv3_large.csv",
            index=False
        )
        save_json(
            all_results,
            combined_out / "all_datasets_summary_mobilenetv3_large.json"
        )
