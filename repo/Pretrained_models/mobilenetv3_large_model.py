# ======================================================
# mobilenetv3_large_all_pipelines.py
# ======================================================
...
BATCH_SIZE = 24        # Slightly smaller batch than V3-Small (more params)
...
pipelines_info = [

    {
        ...
        "csv": r"/aakaou/pipeline1_mobilenetv3large_predictions.csv"
    },

    {
        "images": r"/aakaou/pipeline2_seg_overlays",
        "csv": r"/aakaou/pipeline2_mobilenetv3large_predictions.csv"
    },

    {
        "images": r"/aakaou/pipeline3_seg_overlays",
        "csv": r"/aakaou/pipeline3_mobilenetv3large_predictions.csv"
    },

    {
        "images": r"/aakaou/pipeline4_overlays",
        "csv": r"/aakaou/pipeline4_mobilenetv3large_predictions.csv"
    }
...
for pipe in pipelines_info:
    ...
    print(f"\n🚀 Training MobileNetV3-Large on {pipe['images']}")
    ...
    print("✅ MobileNetV3-Large model ready")
