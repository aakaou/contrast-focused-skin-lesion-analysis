...
OUTPUT_CSV = "/kaggle/working/ham10000_densenet201_7class_predictions_p1.csv"
...
# ==========================================================
# 4️⃣ LOAD DENSENET201 MODEL (IMAGENET PRETRAINED)
# ==========================================================
...
predictions = Dense(7, activation='softmax')(x)  # 7-class softmax
