"""
ham10000_efficientnetb1_pipeline.py

Full pipeline for HAM10000 7-class classification using EfficientNetB1:
- Loads images from a folder
- Preprocesses for EfficientNetB1
...
OUTPUT_CSV = "/kaggle/working/ham10000_efficientnetb1_7class_predictions_p1.csv"
...
# ==========================================================
# 4️⃣ LOAD EFFICIENTNETB1 MODEL WITH CUSTOM HEAD
# ==========================================================
...
print("✅ EfficientNetB1 7-class model loaded")
...
for i in tqdm(range(0, len(proc_files), BATCH_SIZE), desc="EfficientNetB1 Predicting"):
...
plt.title("ROC Curves - EfficientNetB1 7-class", fontsize=16, fontweight='bold')
