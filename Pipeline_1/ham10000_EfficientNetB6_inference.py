# ============================================================
# EfficientNetB6 HAM10000 7-Class Prediction + Evaluation
# ============================================================
...
from tensorflow.keras.models import Model  # To build custom model
...
OUTPUT_CSV = "/aakaou/ham10000_efficientnetb6_7class_predictions_p1.csv"  # CSV output
IMG_SIZE = (528, 528)        # EfficientNetB6 input size
BATCH_SIZE = 8               # Smaller batch due to large 528x528 images

# ============================================================
# 3️⃣ Build EfficientNetB6 model with custom top layers
# ============================================================
# Load EfficientNetB6 base (ImageNet weights, exclude top layers)
...
# Final softmax layer for 7 HAM10000 classes
predictions = Dense(7, activation='softmax')(x)

# Build full model
model = Model(inputs=base_model.input, outputs=predictions)

# Freeze all layers (inference only)
model.trainable = False
print("✅ EfficientNetB6 7-class model loaded (B5 → B6 TITAN!)")
...
proc_files.sort(key=lambda x: extract_number(x.name))  # Sort by ISIC ID
...
for i in tqdm(range(0, len(proc_files), BATCH_SIZE), desc="EfficientNetB6 Predicting"):
...
if results:
    ...
    print(f"✅ EfficientNetB6 7-class predictions saved: {OUTPUT_CSV}")
...
print("✅ EfficientNetB6 Complete!")
print("🌋 B6 TITAN: 528x528 + 43M params = ROC KING contender!")
...
plt.title('ROC Curves - EfficientNetB6 7-class (predictions_p1)', fontsize=16, fontweight='bold')
...
# ============================================================
print(f"\n✅ ROC Plot saved: efficientnetb6_p1_roc_curve.png")
