...
OUT_DIR = Path("/kaggle/working/HAM10000_segmented_p1") # Optional output folder for segmented images
OUTPUT_CSV = "/kaggle/working/ham10000_mobilenetv3small_7class_predictions_p1.csv"  # CSV output path
